<div class="navbar nav bg-light tijara-nav text-black-50">
    TijaraShop / Liste des catégories
                    ...
                    <ul class="nav">
                        <li class="nav-item">
							...
							if ( $sub ) {
								...
								if ( $parent->parent == - 1 ) {
									?>
                                    <a href="admin.php?page=TijaraShop/cat"><i class="fas fa-arrow-left"></i> Retour à
                                        la liste</a>
									<?php
								} else {
									?>
                                    <a href="admin.php?page=TijaraShop/cat&action=listSub&catId=<?= $parent->parent ?>"><i
